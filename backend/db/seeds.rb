...
csv_file_janssen = File.read("/Users/annacorrieri/Development/code/Mod3/Phase3-project/phase-3-backend/backend/db/migrate/Janssen.csv")
...
csv_file_moderna = File.read("/Users/annacorrieri/Development/code/Mod3/Phase3-project/phase-3-backend/backend/db/migrate/Moderna.csv")
...
csv_file_pfizer = File.read("/Users/annacorrieri/Development/code/Mod3/Phase3-project/phase-3-backend/backend/db/migrate/Pfizer.csv")
